        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="${pageContext.request.contextPath}/stockin/add" class="btn btn-success">Record New Stock In</a>
                </div>
                            ...
                            <tbody>
                                <c:forEach var="stockin" items="${stockIns}">
                                    <tr>
                                        ...
                                        <td>${supplierCompanies[stockin.supplierId]}</td>
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                <a href="${pageContext.request.contextPath}/stockin/edit/${stockin.id}"
                                                ...
                                                <a href="${pageContext.request.contextPath}/stockin/delete/${stockin.id}"
                                ...
                                <c:if test="${empty stockIns}">
                                    <tr>
                                        <td colspan="9" class="text-center">No stock in records found.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
