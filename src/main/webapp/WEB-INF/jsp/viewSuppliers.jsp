                    ...
                    <div class="main-content">
                        ...
                        <div class="page-content">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="${pageContext.request.contextPath}/suppliers/add" class="btn btn-success">Add
                                    New Supplier</a>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="supplierSearch" class="form-control border-start-0"
                                        ...
                                        oninput="filterTable('supplierSearch', 'supplierTable')">
                                </div>
                            </div>
                                            ...
                                            <c:forEach var="supplier" items="${suppliers}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/suppliers/delete/${supplier.id}"
